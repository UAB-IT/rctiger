	...
	<div class="pt-12 pb-1">
		<div class="max-w-1340 mx-auto grid grid-cols-12 px-4 xl:px-0 lg:gap-10 xl:gap-0">
			...
			<div class="lg:col-span-8 xl:col-span-6 grid grid-cols-2 gap-10">
				<div>
					<h2 class="mt-0 mb-2 text-xl text-white tracking-widest uppercase">Research Computing Resources</h2>
					<ul class="divide-solid divide-uab-green divide-x-0 divide-y leading list-none m-0 p-0">
						...
						<li><a href="/business/home/about/communications-toolkit" class="uab-footer__link text-white block py-1 no-underline hover:no-underline">RC communication toolkit</a></li>
					</ul>
				</div>
				<div>
			...
			<div class="lg:col-span-8 xl:col-span-6 my-2">
				<ul class="divide-solid divide-white divide-x divide-y-0 flex flex-wrap list-none p-0 text-xs text-white leading-none">
					...
					<li class="px-3"><a class="no-underline text-white" href="https://www.uab.edu/toolkit/web/terms-of-use">Terms of Use <i class="far fa-external-link-alt ml-1 text-xs" aria-hidden="true"></i> <span class="sr-only">opens a new website</span></a></li>
					<li class="px-4">© 2022 The University of Alabama at Birmingham</li>
				</ul>
			</div>
		</div>
	{#if isTextVisible}
